...
//PrintPercentilsWithDefaults
func PrintPercentilsWithDefaults(label string, dataList[]string){
	PrintPercentiles(label, dataList, 11, 8, "%.2f", true, true,
                      false, []int{99, 75, 50, 25})
}

//PrintPercentiles prints formatted percentiles using numpy from data in a list
func PrintPercentiles(label string, dataList []string, indent int, width int, strformat string, pmin bool, pmax bool,
                      reverse bool, percentiles []int){
